...
<script lang="ts">
    ...
    export default Vue.extend({
        ...
        computed:{
          ...
          community(){
            if(this.$route.matched[0].path=="/community")
            {
              console.log(1111111)
              return 'community'
            }
